...
sed -i "s/upload_max_filesize = .*/upload_max_filesize = 100M/" /etc/php/7.4/cli/php.ini
sed -i "s/post_max_size = .*/post_max_size = 100M/" /etc/php/7.4/cli/php.ini
...
sed -i "s/^user = www-data/user = ${DEPLOY_USER}/" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/^group = www-data/group = ${DEPLOY_USER}/" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/;listen\.owner.*/listen.owner = ${DEPLOY_USER}/" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/;listen\.group.*/listen.group = ${DEPLOY_USER}/" /etc/php/7.4/fpm/pool.d/www.conf
